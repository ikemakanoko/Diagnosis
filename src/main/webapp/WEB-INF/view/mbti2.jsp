...
<body>
	<!-- 画像を表示させたい -->
	<img src="images/capital_m.png" alt="M" width="150">
	<img src="images/capital_b.png" alt="B" width="150">
	<img src="images/capital_t.png" alt="T" width="150">
	<img src="images/capital_i.png" alt="I" width="150">
	...
	<form action="" method="post">
		...
		<p>
			...
			<!-- Jの質問 -->
			<label for="JP">計画性があり、決断力がある 秩序を守る 几帳面 完璧に素早くこなす A型っぽいとよく言われる</label>
		</p>
		<p>
